import{j as e}from"./index-DlC1yEB1.js";import{r as d}from"./index-D5jfS-9e.js";import{g as u,h as c,K as _e,J as Ke,S as s,l as ce,D as P,P as pe,Q,q as Je,G as $e,w as Xe,u as Ye,H as Ze,I as en,O as nn,f as tn,d as me,T as he,U as an,W as on,e as rn}from"./data-xFxyZv38.js";import"./index-lf5wH9A6.js";const ln=[40,80,120,200],L=i=>{var $,X,Y,Z,ee,ne;const{enableRtl:j,enableRipple:je,localDataCount:w,isTextWrapData:_,isDialogInsideGrid:K,isStrictMode:We,isMultipleChildren:Ne,parentContainerHeight:Be="93vh",isCustomBinding:W,serverPageSize:D,...t}=i;((Y=(X=t.columns)==null?void 0:X[(($=t.columns)==null?void 0:$.length)-1])==null?void 0:Y.headerText)==="Command Actions"&&(t.columns[((Z=t.columns)==null?void 0:Z.length)-1].getCommandItems=()=>[e.jsx(u,{type:c.Edit},"Edit"),e.jsx(u,{type:c.Delete},"Delete"),e.jsx(u,{type:c.Update},"Update"),e.jsx(u,{type:c.Cancel},"Cancel")]);const p=d.useRef(null),N=d.useRef(null),[B,He]=d.useState(!0),[h,Ue]=d.useState(!1),H=d.useMemo(()=>_?_e(w):Ke(w,t.columns),[w,(ee=t.columns)==null?void 0:ee.length]),[Le,Qe]=d.useState({result:[],count:0,hasMore:((ne=i.virtualizationSettings)==null?void 0:ne.scrollMode)===s.Infinite}),J=n=>{var S,v,y,C,b,x,te,ae,oe,re,le,T,ie,E,se,A,de,ue;const m=new P(H),l=new Q;if((S=n.where)!=null&&S.length){let a;const o=n.where[0].predicates;for(let r=0;r<o.length;r++)a?a=a.and(new pe(o[r].field,o[r].operator,o[r].value,o[r].ignoreCase,o[r].ignoreAccent,o[r].matchCase)):a=new pe(o[r].field,o[r].operator,o[r].value,o[r].ignoreCase,o[r].ignoreAccent,o[r].matchCase);l.where(a)}if((v=n.search)!=null&&v.length){const{fields:a,value:o}=n.search[0];l.search(o,a)}if((y=n.sort)!=null&&y.length&&n.sort.forEach(a=>{l.sortBy(a.field,a.direction)}),(C=n.aggregates)!=null&&C.length||(x=(b=p.current)==null?void 0:b.aggregates)!=null&&x.length){const a=(te=n.aggregates)!=null&&te.length?n.aggregates:(ae=p.current)==null?void 0:ae.aggregates;for(let o=0;o<(a==null?void 0:a.length);o++)if((oe=a[o])!=null&&oe.columns)for(let r=0;r<((re=a[o])==null?void 0:re.columns.length);r++){const g=a[o].columns[r];if(Array.isArray(g.type))for(let U=0;U<g.type.length;U++)l.aggregate((ie=(T=(le=g.type)==null?void 0:le[U])==null?void 0:T.toLowerCase)==null?void 0:ie.call(T),g.field);else l.aggregate((se=(E=g.type)==null?void 0:E.toLowerCase)==null?void 0:se.call(E),g.field)}else{const r=a[o];l.aggregate((de=(A=r.type)==null?void 0:A.toLowerCase)==null?void 0:de.call(A),r.field)}}if(n.take&&n.skip){const a=n.skip/n.take+1,o=n.take;l.page(a,o)}else if(n.skip===0&&n.take)l.page(1,n.take);else if(n.skip&&((ue=i.virtualizationSettings)==null?void 0:ue.scrollMode)===s.Infinite){const a=n.skip/D+1;l.page(a,D)}n.requiresCounts&&l.requiresCount(),console.log("CustomBinding Callback Params: ",n),console.log("CustomBinding Query: ",l),m.executeQuery(l).then(a=>{Qe({...a,hasMore:H.length>(n.skip??0)+a.result.length})})};d.useEffect(()=>{var n,m,l,S,v,y,C,b,x;W&&h&&J({skip:((n=t==null?void 0:t.pageSettings)==null?void 0:n.currentPage)*((m=t==null?void 0:t.pageSettings)==null?void 0:m.pageSize)||0,...((l=t.virtualizationSettings)==null?void 0:l.scrollMode)!==s.Infinite||(S=t.pageSettings)!=null&&S.estimatedTotalRecordsCount||((v=t.pageSettings)==null?void 0:v.pageSizeControlledBy)==="client"?{take:D??((y=t==null?void 0:t.pageSettings)==null?void 0:y.pageSize)??(((C=t.virtualizationSettings)==null?void 0:C.scrollMode)===s.Auto||!((b=t.virtualizationSettings)!=null&&b.scrollMode)?12:50)}:{take:D},where:[],search:[],sort:[],aggregates:[],...((x=t.virtualizationSettings)==null?void 0:x.scrollMode)!==s.Infinite?{requiresCounts:!0}:{}})},[h]);const R=()=>e.jsxs(e.Fragment,{children:[e.jsxs("button",{onClick:()=>{var n,m;h&&window.localStorage.removeItem((m=(n=p==null?void 0:p.current)==null?void 0:n.getDataModule())==null?void 0:m.dataManager.guidId),Ue(!h)},children:[h?"Destroy":"Render"," Data Grid"]}),w&&!_&&e.jsxs("button",{onClick:()=>He(!B),children:[B?"Uniform":"Non Uniform"," Row Height Applied"]}),h&&e.jsx(Je,{dir:j?"rtl":"ltr",ripple:je,locale:t.locale,children:e.jsx($e,{ref:p,dataSource:W?Le:w?H:[],onDataRequest:W?J:void 0,...t,columns:t.children?void 0:t.columns,aggregates:t.children?void 0:t.aggregates,getRowHeight:B?null:n=>ln[n.rowIndex%4],children:Ne?t.children.props.children:t.children})}),e.jsx("button",{onClick:()=>{console.log(p)},children:"dummy navigation checking button with get GridRef"})]});return e.jsx("div",{ref:N,style:{height:Be,isolation:"isolate"},children:We?e.jsx(d.StrictMode,{children:K?e.jsx(ce,{open:!0,fullScreen:!0,target:N.current,children:R()}):R()}):K?e.jsx(ce,{open:!0,fullScreen:!0,target:N.current,children:R()}):R()})};try{L.displayName="LargeDataGridTest",L.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{parentContainerHeight:{defaultValue:null,description:"",name:"parentContainerHeight",required:!1,type:{name:"Height<string | number>"}},enableRtl:{defaultValue:null,description:`Enables right-to-left (RTL) direction for the grid.
...
}`,...(we=(fe=G.parameters)==null?void 0:fe.docs)==null?void 0:we.source}}};var Se,ve,ye;q.parameters={...q.parameters,docs:{...(Se=q.parameters)==null?void 0:Se.docs,source:{originalSource:`{
  args: {
...
}`,...(ye=(ve=q.parameters)==null?void 0:ve.docs)==null?void 0:ye.source}}};var Ce,be,xe;k.parameters={...k.parameters,docs:{...(Ce=k.parameters)==null?void 0:Ce.docs,source:{originalSource:`{
  args: {
...
}`,...(xe=(be=k.parameters)==null?void 0:be.docs)==null?void 0:xe.source}}};var De,Re,Te;M.parameters={...M.parameters,docs:{...(De=M.parameters)==null?void 0:De.docs,source:{originalSource:`{
  args: {
    dataSource: new DataManager({
...
}`,...(Te=(Re=M.parameters)==null?void 0:Re.docs)==null?void 0:Te.source}}};var Ee,Ae,Ge;F.parameters={...F.parameters,docs:{...(Ee=F.parameters)==null?void 0:Ee.docs,source:{originalSource:`{
  args: {
    dataSource: employeeData,
    children: <Columns>\r
