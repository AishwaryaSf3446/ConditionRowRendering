import{j as e}from"./index-DlC1yEB1.js";import{r as s}from"./index-D5jfS-9e.js";import{g as u,h as c,K as Ke,J as Je,S as d,l as pe,D as P,P as me,Q,q as $e,G as Xe,w as Ye,u as Ze,e as _,H as en,I as nn,O as tn,f as an,d as he,T as ge,U as on,W as rn}from"./data-VkzBCiZs.js";import"./index-lf5wH9A6.js";const ln=[40,80,120,200],L=l=>{var X,Y,Z,ee,ne,te;const{enableRtl:j,enableRipple:We,localDataCount:w,isTextWrapData:K,isDialogInsideGrid:J,isStrictMode:Ne,isMultipleChildren:He,parentContainerHeight:Ue="93vh",isCustomBinding:W,serverPageSize:D,...t}=l;((Z=(Y=t.columns)==null?void 0:Y[((X=t.columns)==null?void 0:X.length)-1])==null?void 0:Z.headerText)==="Command Actions"&&(t.columns[((ee=t.columns)==null?void 0:ee.length)-1].getCommandItems=()=>[e.jsx(u,{type:c.Edit},"Edit"),e.jsx(u,{type:c.Delete},"Delete"),e.jsx(u,{type:c.Update},"Update"),e.jsx(u,{type:c.Cancel},"Cancel")]);const p=s.useRef(null),N=s.useRef(null),[H,Be]=s.useState(!0),[h,Le]=s.useState(!1),U=s.useMemo(()=>K?Ke(w):Je(w,t.columns),[w,(ne=t.columns)==null?void 0:ne.length]),[Qe,_e]=s.useState({result:[],count:0,hasMore:((te=l.virtualizationSettings)==null?void 0:te.scrollMode)===d.Infinite}),$=n=>{var S,y,v,C,b,x,ae,oe,re,le,ie,E,se,T,de,A,ue,ce;const m=new P(U),i=new Q;if((S=n.where)!=null&&S.length){let a;const o=n.where[0].predicates;for(let r=0;r<o.length;r++)a?a=a.and(new me(o[r].field,o[r].operator,o[r].value,o[r].ignoreCase,o[r].ignoreAccent,o[r].matchCase)):a=new me(o[r].field,o[r].operator,o[r].value,o[r].ignoreCase,o[r].ignoreAccent,o[r].matchCase);i.where(a)}if((y=n.search)!=null&&y.length){const{fields:a,value:o}=n.search[0];i.search(o,a)}if((v=n.sort)!=null&&v.length&&n.sort.forEach(a=>{i.sortBy(a.field,a.direction)}),(C=n.aggregates)!=null&&C.length||(x=(b=p.current)==null?void 0:b.aggregates)!=null&&x.length){const a=(ae=n.aggregates)!=null&&ae.length?n.aggregates:(oe=p.current)==null?void 0:oe.aggregates;for(let o=0;o<(a==null?void 0:a.length);o++)if((re=a[o])!=null&&re.columns)for(let r=0;r<((le=a[o])==null?void 0:le.columns.length);r++){const g=a[o].columns[r];if(Array.isArray(g.type))for(let B=0;B<g.type.length;B++)i.aggregate((se=(E=(ie=g.type)==null?void 0:ie[B])==null?void 0:E.toLowerCase)==null?void 0:se.call(E),g.field);else i.aggregate((de=(T=g.type)==null?void 0:T.toLowerCase)==null?void 0:de.call(T),g.field)}else{const r=a[o];i.aggregate((ue=(A=r.type)==null?void 0:A.toLowerCase)==null?void 0:ue.call(A),r.field)}}if(n.take&&n.skip){const a=n.skip/n.take+1,o=n.take;i.page(a,o)}else if(n.skip===0&&n.take)i.page(1,n.take);else if(n.skip&&((ce=l.virtualizationSettings)==null?void 0:ce.scrollMode)===d.Infinite){const a=n.skip/D+1;i.page(a,D)}n.requiresCounts&&i.requiresCount(),console.log("CustomBinding Callback Params: ",n),console.log("CustomBinding Query: ",i),m.executeQuery(i).then(a=>{_e({...a,hasMore:U.length>(n.skip??0)+a.result.length})})};s.useEffect(()=>{var n,m,i,S,y,v,C,b,x;W&&h&&$({skip:((n=t==null?void 0:t.pageSettings)==null?void 0:n.currentPage)*((m=t==null?void 0:t.pageSettings)==null?void 0:m.pageSize)||0,...((i=t.virtualizationSettings)==null?void 0:i.scrollMode)!==d.Infinite||(S=t.pageSettings)!=null&&S.estimatedTotalRecordsCount||((y=t.pageSettings)==null?void 0:y.pageSizeControlledBy)==="client"?{take:D??((v=t==null?void 0:t.pageSettings)==null?void 0:v.pageSize)??(((C=t.virtualizationSettings)==null?void 0:C.scrollMode)===d.Auto||!((b=t.virtualizationSettings)!=null&&b.scrollMode)?12:50)}:{take:D},where:[],search:[],sort:[],aggregates:[],...((x=t.virtualizationSettings)==null?void 0:x.scrollMode)!==d.Infinite?{requiresCounts:!0}:{}})},[h]);const R=()=>e.jsxs(e.Fragment,{children:[e.jsxs("button",{onClick:()=>{var n,m;h&&window.localStorage.removeItem((m=(n=p==null?void 0:p.current)==null?void 0:n.getDataModule())==null?void 0:m.dataManager.guidId),Le(!h)},children:[h?"Destroy":"Render"," Data Grid"]}),w&&!K&&e.jsxs("button",{onClick:()=>Be(!H),children:[H?"Uniform":"Non Uniform"," Row Height Applied"]}),h&&e.jsx($e,{dir:j?"rtl":"ltr",ripple:We,locale:t.locale,children:e.jsx(Xe,{ref:p,dataSource:W?Qe:w?U:[],onDataRequest:W?$:void 0,...t,columns:t.children?void 0:t.columns,aggregates:t.children?void 0:t.aggregates,getRowHeight:H?null:n=>ln[n.rowIndex%4],children:He?t.children.props.children:t.children})}),e.jsx("button",{onClick:()=>{console.log(p)},children:"dummy navigation checking button with get GridRef"})]});return e.jsx("div",{ref:N,style:{height:Ue,isolation:"isolate"},children:Ne?e.jsx(s.StrictMode,{children:J?e.jsx(pe,{open:!0,fullScreen:!0,target:N.current,children:R()}):R()}):J?e.jsx(pe,{open:!0,fullScreen:!0,target:N.current,children:R()}):R()})};try{L.displayName="LargeDataGridTest",L.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{parentContainerHeight:{defaultValue:null,description:"",name:"parentContainerHeight",required:!1,type:{name:"Height<string | number>"}},enableRtl:{defaultValue:null,description:`Enables right-to-left (RTL) direction for the grid.
...
/>
\`\`\``,name:"selectionSettings",required:!1,type:{name:"SelectionSettings"}},isRowSelectable:{defaultValue:null,description:`Callback to determine whether a row is selectable and how its checkbox renders.
Evaluated per row during selection operations, header state computation, and checkbox rendering.
When not provided, all rows are considered selectable (backward-compatible default).
...
or a {@link RowSelectableParams } object for full per-row control
@example // Boolean form: exclude rejected records from selection
isRowSelectable={(row) => row.status !== 'Rejected'}
@example // Object form: hide checkbox for archived rows, show disabled for pending
isRowSelectable={(row) => ({
  selectable: row.status === 'Active',
  showDisabledCheckboxes: row.status === 'Pending'
})}`,name:"isRowSelectable",required:!1,type:{name:"IsRowSelectable<unknown>"}},sortSettings:{defaultValue:{value:"{ columns: [], allowUnsort: true, enabled: false, mode: 'Multiple' }"},description:`Specifies the sorting configuration for the grid, includes options to enable/disable sorting and controlling how data is ordered.
...
\`\`\``,name:"onDeleteDialogOpen",required:!1,type:{name:"(eventArgs: DeleteDialogEventArgs) => void"}}}}}catch{}const hn={title:"Grid/VirtualGridBase",component:L,parameters:{layout:"fullscreen",docs:{description:{component:"A fully configurable Grid component with performance comparison capabilities."}}},argTypes:{localDataCount:{control:"select",options:["0","100","1000","10000","100000"],description:"Grid Local DataSource Count"}}},f=nn(100,!1),O=[{columns:en(f.length)}],sn=l=>l.id%2===0?{selectable:!1}:!0;f.unshift({type:_.Checkbox,width:50,allowFilter:!1});f.push({headerText:"Command Actions",width:200,getCommandItems:()=>[e.jsx(u,{type:c.Edit},"Edit"),e.jsx(u,{type:c.Delete},"Delete"),e.jsx(u,{type:c.Update},"Update"),e.jsx(u,{type:c.Cancel},"Cancel")]});const G={args:{localDataCount:1e5,columns:f,aggregates:O,isRowSelectable:sn,virtualizationSettings:{enabled:!0},editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Add","Edit","Delete","Update","Cancel","Search"],searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0,type:"Excel",enableFilterBarOperator:!0},height:"100%"}},k={args:{localDataCount:2e6,columns:f.slice(1,11),editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Add","Edit","Delete","Update","Cancel","Search"],searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0,enableFilterBarOperator:!0},pageSettings:{enabled:!0,pageSize:2e6},height:"100%"}},q={args:{dataSource:new P({url:"https://ej2services.syncfusion.com/js/development/api/UrlDataSource",adaptor:new on}),query:new Q().addParams("dataCount","100000").addParams("serverpagesize","30"),toolbar:["Search"],isRowSelectable:l=>l.Status==="Inactive"?{selectable:!1}:!0,columns:[{type:_.Checkbox,width:40,allowEdit:!1},{field:"EmployeeID",visible:!0,headerText:"Employee ID",isPrimaryKey:!0,width:"150"},{field:"Employees",headerText:"Employee Name",width:"230",clipMode:"EllipsisWithTooltip"},{field:"Designation",headerText:"Designation",width:"170",clipMode:"EllipsisWithTooltip"},{field:"Mail",headerText:"Mail",width:"230"},{field:"Location",headerText:"Location",width:"140"},{field:"Status",headerText:"Status",width:"130"},{field:"Trustworthiness",headerText:"Trustworthiness",width:"160"},{field:"Rating",headerText:"Rating",width:"220"},{field:"Software",headerText:"Software Proficiency",width:"180",format:"C2"},{field:"CurrentSalary",headerText:"Current Salary",width:"200",format:"C2"},{field:"Address",headerText:"Address",width:"240",clipMode:"EllipsisWithTooltip"}],aggregates:[{columns:[{field:"EmployeeID",type:"Count",footerTemplate:l=>`Employee Count: ${l.Count}`},{field:"CurrentSalary",type:"Sum",format:"C2",footerTemplate:l=>`Total Salary: ${l.Sum}`}]}],searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0,type:"Excel"},virtualizationSettings:{enableCache:!1,scrollMode:d.Virtual},height:"100%"}},M={args:{dataSource:new P({url:"https://ej2services.syncfusion.com/react/development/api/GridWebAPIService",adaptor:new rn}),columns:[{type:_.Checkbox,width:40,allowEdit:!1},{field:"OrderID",headerText:"OrderID",isPrimaryKey:!0,width:"130",allowSearch:!1},{field:"CustomerID",headerText:"CustomerID",width:"230",clipMode:"EllipsisWithTooltip"},{field:"ShipCity",headerText:"ShipCity",width:"230"},{field:"EmployeeID",headerText:"EmployeeID",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1},{field:"EmployeeName",headerText:"EmployeeName",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"Designation",headerText:"Designation",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"CurrentSalary",headerText:"CurrentSalary",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1}],sortSettings:{enabled:!0},filterSettings:{enabled:!0},pageSettings:{enabled:!0},height:"100%",query:new Q().addParams("serverpagesize","50"),isRowSelectable:l=>l.OrderID%2===0?{selectable:!1}:!0}},F={args:{dataSource:Ye,children:e.jsxs(an,{children:[e.jsx(he,{headerText:"Employee Image",width:"180",textAlign:ge.Center,field:"EmployeeID"}),e.jsx(he,{headerText:"Employee Details",width:"300",textAlign:ge.Left,field:"FirstName"})]}),className:"row-template",toolbar:["Search"],selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0},height:"100%",rowTemplate:l=>{const j=`https://npmci-react.syncfusion.com/development-react-ui/images/grid/${l.EmployeeID}.png`;return e.jsxs("tr",{className:"templateRow",children:[e.jsx("td",{className:"photo",children:e.jsx("img",{src:j,alt:l.EmployeeID.toString()})}),e.jsx("td",{className:"details",children:e.jsxs("table",{className:"CardTable",cellPadding:3,cellSpacing:2,children:[e.jsxs("colgroup",{children:[e.jsx("col",{style:{width:"30%"}}),e.jsx("col",{style:{width:"10%"}})]}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"First Name"}),e.jsx("td",{children:":"}),e.jsx("td",{children:l.FirstName})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"Last Name"}),e.jsx("td",{children:":"}),e.jsx("td",{children:l.LastName})]}),e.jsxs("tr",{children:[e.jsx("td",{className:"CardHeader",children:"Title"}),e.jsx("td",{children:":"}),e.jsx("td",{children:l.Title})]})]})]})})]})}}},dn=[{field:"id"},{field:"username",width:150},{field:"age",width:80,type:"number"},{field:"bio",width:400}],V={args:{localDataCount:1e5,isTextWrapData:!0,columns:dn,height:400,textWrapSettings:{enabled:!0,wrapMode:Ze.Both}}},I={args:{dataSource:new P({url:"https://ej2services.syncfusion.com/react/development/odata/GridInfiniteODataV4",adaptor:new tn}),columns:[{field:"RecordId",headerText:"Record ID"},{field:"AssetGroup",headerText:"Asset Group"},{field:"HourlyCost",headerText:"Hourly Cost"},{field:"EstimatedHours",headerText:"Estimated Hours"},{field:"MaintenanceCost",headerText:"Maintenance Cost"},{field:"RequestedDate",headerText:"Requested Date"},{field:"PlannedDate",headerText:"Planned Date"},{field:"CompletionDate",headerText:"Completion Date"},{field:"Status",headerText:"Status"},{field:"RequestOrigin.Division",headerText:"Request Division"}],virtualizationSettings:{scrollMode:d.Infinite,enableCache:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0},searchSettings:{enabled:!0},toolbar:["Search"],pageSettings:{enabled:!1,pageSize:100,estimatedTotalRecordsCount:500,pageSizeControlledBy:"server"},height:"100%"}},z={args:{serverPageSize:50,localDataCount:1e3,columns:f.slice(1,11),isCustomBinding:!0,virtualizationSettings:{scrollMode:d.Infinite},sortSettings:{enabled:!0},filterSettings:{enabled:!0,enableFilterBarOperator:!0},searchSettings:{enabled:!0},toolbar:["Search"],pageSettings:{enabled:!1,pageSize:100,estimatedTotalRecordsCount:500,pageSizeControlledBy:"client"},height:"100%",aggregates:[{columns:(O==null?void 0:O[0].columns.slice(0,10))??[]}]}};var fe,we,Se;G.parameters={...G.parameters,docs:{...(fe=G.parameters)==null?void 0:fe.docs,source:{originalSource:`{
  args: {
    ...
    //pageSettings: { enabled: true, pageSize: 100000 },
    height: '100%'
  }
}`,...(Se=(we=G.parameters)==null?void 0:we.docs)==null?void 0:Se.source}}};var ye,ve,Ce;k.parameters={...k.parameters,docs:{...(ye=k.parameters)==null?void 0:ye.docs,source:{originalSource:`{
  args: {
...
}`,...(Ce=(ve=k.parameters)==null?void 0:ve.docs)==null?void 0:Ce.source}}};var be,xe,De;q.parameters={...q.parameters,docs:{...(be=q.parameters)==null?void 0:be.docs,source:{originalSource:`{
  args: {
    ...
    query: new Query().addParams('dataCount', '100000').addParams('serverpagesize', '30'),
    toolbar: ['Search'],
...
}`,...(De=(xe=q.parameters)==null?void 0:xe.docs)==null?void 0:De.source}}};var Re,Ee,Te;M.parameters={...M.parameters,docs:{...(Re=M.parameters)==null?void 0:Re.docs,source:{originalSource:`{
  args: {
    dataSource: new DataManager({
    ...
    //  virtualizationSettings: { scrollMode: ScrollMode.Virtual },
    pageSettings: {
      enabled: true
    },
    height: '100%',
...
}`,...(Te=(Ee=M.parameters)==null?void 0:Ee.docs)==null?void 0:Te.source}}};var Ae,Ge,ke;F.parameters={...F.parameters,docs:{...(Ae=F.parameters)==null?void 0:Ae.docs,source:{originalSource:`{
  args: {
    dataSource: employeeData,
    children: <Columns>\r
...
}`,...(ke=(Ge=F.parameters)==null?void 0:Ge.docs)==null?void 0:ke.source}}};var qe,Me,Fe;V.parameters={...V.parameters,docs:{...(qe=V.parameters)==null?void 0:qe.docs,source:{originalSource:`{
  args: {
    localDataCount: 100000,
    isTextWrapData: true,
    columns: muicolumns,
...
}`,...(Fe=(Me=V.parameters)==null?void 0:Me.docs)==null?void 0:Fe.source}}};var Ve,Ie,ze;I.parameters={...I.parameters,docs:{...(Ve=I.parameters)==null?void 0:Ve.docs,source:{originalSource:`{
  args: {
    // localDataCount: 100,
    dataSource: new DataManager({
...
}`,...(ze=(Ie=I.parameters)==null?void 0:Ie.docs)==null?void 0:ze.source}}};var Oe,Pe,je;z.parameters={...z.parameters,docs:{...(Oe=z.parameters)==null?void 0:Oe.docs,source:{originalSource:`{
  args: {
    serverPageSize: 50,
    localDataCount: 1000,
    columns: columns.slice(1, 11),
...
}`,...(je=(Pe=z.parameters)==null?void 0:Pe.docs)==null?void 0:je.source}}};const gn=["LocalData","OverComeBrowserLimit","UrlAdaptorData","WebApiAdaptorData","RowTemplate","TextWrapSample","ODataV4Sample","CustomBindingSample"];export{z as CustomBindingSample,G as LocalData,I as ODataV4Sample,k as OverComeBrowserLimit,F as RowTemplate,V as TextWrapSample,q as UrlAdaptorData,M as WebApiAdaptorData,gn as __namedExportsOrder,hn as default};
